...
#define __NR_kutrace_control __ARM_NR_kutrace

/* Take over last syscall64 number for tracing scheduler call/return */
#define KUTRACE_SCHEDSYSCALL __NR_LITMUS + NR_litmus_syscalls
...
#define KUTRACE_INVALID_OPCODE  14
...
/* Allow calling from assembly */
asmlinkage void asm_kutrace1(u32 event, u32 arg);
